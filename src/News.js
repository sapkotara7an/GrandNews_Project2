...
function News() {
  ...
  return (
   ...
   <main className="responsive-wrapper container my-4">
  ...
  <div className="magazine-layout">
    <div className="magazine-column">
      <article className="article">
        <h2 className="article-title article-title--large">
          <a href="#" className="article-link">The First Signs of <mark className="mark mark--primary">Alcoholic Liver</mark> Damage Are Not in the Liver</a>
        </h2>
        ...
        <div className="article-author">
          <div className="article-author-img">
            <img src="https://assets.codepen.io/285131/author-3.png"  width='50%'/>
          </div>
    ...
    <div className="magazine-column">
      <article className="article">
        <figure className="article-img">
          <img src="https://images.unsplash.com/photo-1484807352052-23338990c6c6?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"   width='50%'/>
        </figure>
        <h2 className="article-title article-title--medium">
    ...
    <div className="magazine-column">
      <article className="article">
        <figure className="article-img">
          <img src="https://images.unsplash.com/photo-1512521743077-a42eeaaa963c?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1351&q=80"  width='90%' />
        </figure>
        <h2 className="article-title article-title--small">
          <a href="#" className="article-link">To Become <mark className="mark mark--secondary">Happier</mark>, Ask Yourself These Two Questions Every Night</a>
        </h2>
        <div className="article-creditation">
      ...
      <article className="article">
        <figure className="article-img">
          <img src="https://images.unsplash.com/photo-1569234817121-a2552baf4fd4?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"   width='95%'/>
        </figure>
        <h2 className="article-title article-title--small">
          <a href="#" className="article-link">10 Things I Stole From People Smarter Than Me</a>
        </h2>
        <div className="article-creditation">
          <p>By Jonathan O'Connell</p>
        </div>
    ...
    <div className="magazine-column">
      <article className="article">
        <h2 className="article-title article-title--medium">
          <a href="#" className="article-link">Traveller Visiting Ice Cave With Amazing Eye-Catching Scenes</a>
        </h2>
        <div className="article-excerpt">
      ...
      <article className="article">
        <small className="article-category">
          <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={28} height={22} viewBox="0 0 28 22">
            <defs>
        ...
        <h2 className="article-title article-title--medium">
          <a href="#" className="article-link">Things to Do After 6 P.M Will Enrich <mark className="mark mark--tertiary">Your Life</mark></a>
        </h2>
        <div className="article-podcast-player">
          <button className="podcast-play-button">
            <svg xmlns="http://www.w3.org/2000/svg" width={192} height={192} fill="#000000" viewBox="0 0 256 256"><rect width={256} height={256} fill="none" /><path d="M232.3125,114.34375,88.34375,26.35937A15.99781,15.99781,0,0,0,64,40.00781V215.99219a16.00521,16.00521,0,0,0,24.34375,13.64843L232.3125,141.65625a16.00727,16.00727,0,0,0,0-27.3125Z" /></svg>
          </button>
          <div className="podcast-progression">
          </div>
